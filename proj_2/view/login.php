    ...
    <div id="content">
        <div style="text-align: left; padding: 0;">
            <div id="content">
                ...
                <p><span>Username:</span><input class="contact" type="text" name="your_name" value="" /></p>
                <p><span>password:</span><input class="contact" type="password" name="your_email" value="" /></p>
                ...
                <?php if(isset($message)) echo "<div style = 'color:red'>$message</div>";
                ?>
                </div>
                </form>
                </div>
